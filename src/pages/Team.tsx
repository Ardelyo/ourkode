...
const TEAM = [
  { 
    ...
    role: 'KEPALA TEKNISI', 
    id: '01',
    bio: 'Mantan arsitek sistem di startup unicorn. Terobsesi dengan performa dan clean code.',
  ...
  { 
    ...
    role: 'DESAINER UI/UX', 
    id: '02',
    bio: 'Mengubah kompleksitas menjadi antarmuka yang intuitif dan brutalist.',
  ...
  { 
    ...
    id: '03',
    bio: 'Penguasa database dan arsitektur microservices. Tidak pernah tidur.',
  ...
  { 
    ...
    role: 'MANAJER PRODUK', 
    id: '04',
    bio: 'Menjembatani visi bisnis dengan realitas teknis tanpa kompromi.',
  ...
  { 
    ...
    id: '05',
    bio: 'Penyihir CSS dan GSAP. Membuat web terasa hidup dan bernapas.',
  ...
  { 
    ...
    role: 'TEKNISI DEVOPS', 
    id: '06',
    bio: 'Otomatisasi segalanya. Menjaga server tetap hidup di tengah badai traffic.',
            ...
            >
              ...
              <div className="relative w-full aspect-[4/5] overflow-hidden bg-white dark:bg-[#111] mb-8 border border-black/10 dark:border-white/10">
                ...
                <div className="absolute bottom-6 right-6 z-20 flex gap-4 overflow-hidden">
                  <a href="#" className="text-black dark:text-white hover:text-emerald-400 translate-y-12 group-hover:translate-y-0 transition-transform duration-500 delay-100"><Github size={20} /></a>
                  <a href="#" className="text-black dark:text-white hover:text-emerald-400 translate-y-12 group-hover:translate-y-0 transition-transform duration-500 delay-150"><Linkedin size={20} /></a>
                  <a href="#" className="text-black dark:text-white hover:text-emerald-400 translate-y-12 group-hover:translate-y-0 transition-transform duration-500 delay-200"><Twitter size={20} /></a>
                </div>
              </div>
